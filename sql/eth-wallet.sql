/*
 ...
 Source Server         : RRT拼团11111111111
 Source Server Type    : MySQL
 Source Server Version : 80024
 Source Host           : 47.57.246.225:3306
...
CREATE TABLE `address`  (
  ...
  `user_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户标识',
...
CREATE TABLE `casbin_rule`  (
  `ptype` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
INSERT INTO `currency` VALUES (3, 'heco', 'HT', '0x0000000000000000000000000000000000000000', 18,0,0, NULL, '2022-05-17 17:49:23');
...
INSERT INTO `currency` VALUES (64, 'eth', 'ETH', '0x0000000000000000000000000000000000000000', 18,0,0, NULL, '2023-10-09 01:14:43');
...
CREATE TABLE `demo_gen`  (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `demo_name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '姓名',
  `demo_age` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '年龄',
  `classes` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '班级',
  ...
  `demo_cate` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '分类',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '代码生成测试表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `demo_gen_class`  (
  ...
  `class_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '分类名',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '代码生成关联测试表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `demo_gen_tree`  (
  ...
  `demo_cate` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '分类',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '代码生成树形结构测试表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `fee_list`  (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `main_chain` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '主链',
  `coin_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '手续费币种',
  `withdraw_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '手续费地址',
  `address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '地址',
  `amount` decimal(30, 18) NOT NULL COMMENT '转移手续费',
  `hash` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'hash',
...
CREATE TABLE `height`  (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `main_chain` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '主网',
...
CREATE TABLE `liquidity_currency`  (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `main_chain` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '链',
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '币种名称',
  `contract_address` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '币种地址',
  `decimals` int NOT NULL COMMENT '精度',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `liquidity_swap_trade`  (
  ...
  `main_chain` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '主链',
  `block_hash` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '块hash',
  `from_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '交易方地址',
  `coin_token` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '币种1',
  `coin_token1` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '币种2',
  ...
  `contract_address` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '币种1合约地址',
  `contract_address1` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '币种2合约地址',
  `amount` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '币种1数量',
  `amount1` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '币种2数量',
  `lp_address` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'LP合约地址',
  `fee_num` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '手续费流动性数量',
  `lp_num` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '流动性数量',
  ...
  `hash` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '交易hash',
  `block_height` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '区块高度',
...
CREATE TABLE `monitor_swap_trade`  (
  ...
  `block_hash` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '块hash',
  `from_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '交易方地址',
  `contract_address` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '兑换前币种',
  `contract_address1` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '兑换后币种',
  `amount` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '兑换前数量',
  `amount1` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '兑换后数量',
  `path` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '兑换路径',
  `to_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '收币地址',
...
CREATE TABLE `plugins_manage`  (
  ...
  `p_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '插件名称英文',
  `p_title` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '插件名称',
  `p_description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '插件介绍',
  `p_auth` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '作者',
  `is_install` tinyint NOT NULL DEFAULT 0 COMMENT '是否安装',
  `status` tinyint NOT NULL DEFAULT 0 COMMENT '状态',
  `version` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '当前版本',
  `price` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '价格',
  `download_times` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '下载次数',
  `install_path` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '安装路径（用于卸载）',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `storeIdUni`(`store_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '插件管理' ROW_FORMAT = Dynamic;
...
CREATE TABLE `recharge`  (
  ...
  `main_chain` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '主链',
  `block_hash` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '块hash',
  `coin_token` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '币种1',
  `coin_token1` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '币种2',
  `from_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '发送方地址',
  `to_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '充币地址',
  `amount` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '充币数量',
  `amount1` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '充币2数量',
  `contract_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '币种1合约地址',
  `contract_address1` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '币种2合约地址',
  `hash` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '充币交易hashId',
  `block_height` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '区块高度',
  `call_number` smallint UNSIGNED NULL DEFAULT 0 COMMENT '回调次数',
  `status` smallint NULL DEFAULT 1 COMMENT '状态，1充币成功待归集，2归集上链中，3归集成功, 4归集失败，5充值费用中',
  `imputation_hash` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '归集hash',
  `remarks` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `recharge_type` tinyint UNSIGNED NOT NULL DEFAULT 1 COMMENT '充币类型',
  `token_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '充值的卡牌tokenId  充值卡牌时使用',
...
CREATE TABLE `sys_auth_rule`  (
  ...
  `path` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '路由地址',
  `jump_path` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '跳转路由',
  `component` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '组件路径',
  `is_frame` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否外链 1是 0否',
  `module_type` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '所属模块',
...
) ENGINE = MyISAM AUTO_INCREMENT = 349 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单节点表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_auth_rule` VALUES (331, 0, 'ethWallet', 'ETH钱包管理', 'chart', '', '', 0, 2, 1, 1, 'ethWallet', '', '', 0, 'sys_admin', 0, '2022-04-11 04:12:38', '2022-04-16 17:23:52', NULL);
INSERT INTO `sys_auth_rule` VALUES (332, 331, 'system/ethAddress/get', '查询', '', '', '', 2, 0, 1, 1, '', '', '', 0, 'sys_admin', 0, NULL, '2022-04-16 01:22:04', NULL);
INSERT INTO `sys_auth_rule` VALUES (333, 331, 'system/ethRecharge/list', '充值管理', '', '', '', 1, 7, 1, 1, 'ethRechargeList', '', 'system/ethRecharge/list', 0, 'sys_admin', 0, NULL, '2022-04-16 03:34:38', NULL);
INSERT INTO `sys_auth_rule` VALUES (334, 331, 'system/ethAddress/list', '地址管理', '', '', '', 1, 10, 1, 1, 'ethAddress', '', 'system/ethAddress/list', 0, 'sys_admin', 0, NULL, '2022-04-16 03:34:25', NULL);
INSERT INTO `sys_auth_rule` VALUES (335, 331, 'system/ethCurrency/get', '查询', '', '', '', 2, 0, 1, 1, '', '', '', 0, 'sys_admin', 0, NULL, '2022-04-16 02:05:46', NULL);
INSERT INTO `sys_auth_rule` VALUES (336, 331, 'system/ethCurrency/add', '添加', '', '', '', 2, 0, 1, 1, '', '', '', 0, 'sys_admin', 0, NULL, '2022-04-16 02:05:53', NULL);
INSERT INTO `sys_auth_rule` VALUES (337, 331, 'system/ethCurrency/edit', '修改', '', '', '', 2, 0, 1, 1, '', '', '', 0, 'sys_admin', 0, NULL, '2022-04-16 02:05:58', NULL);
INSERT INTO `sys_auth_rule` VALUES (338, 331, 'system/ethCurrency/delete', '删除', '', '', '', 2, 0, 1, 1, '', '', '', 0, 'sys_admin', 0, NULL, '2022-04-16 02:06:04', NULL);
INSERT INTO `sys_auth_rule` VALUES (339, 331, 'system/ethRecharge/get', '查询', '', '', '', 2, 0, 1, 1, '', '', '', 0, 'sys_admin', 0, NULL, '2022-04-16 02:08:25', NULL);
INSERT INTO `sys_auth_rule` VALUES (340, 331, 'system/ethWithdraw/callback', '发起回调', '', '', '', 2, 0, 1, 1, '', '', '', 0, 'sys_admin', 0, '2022-04-16 03:45:50', '2022-04-16 03:45:50', NULL);
INSERT INTO `sys_auth_rule` VALUES (341, 331, 'system/ethRecharge/callback', '发起回调', '', '', '', 2, 0, 1, 1, '', '', '', 0, 'sys_admin', 0, NULL, '2022-04-16 03:41:55', NULL);
INSERT INTO `sys_auth_rule` VALUES (342, 331, 'system/ethWithdraw/auditSuccess', '审核通过', '', '', '', 2, 0, 1, 1, '', '', '', 0, 'sys_admin', 0, '2022-04-16 17:24:22', '2022-04-16 17:24:22', NULL);
INSERT INTO `sys_auth_rule` VALUES (343, 331, 'system/ethFeeList/list', '手续费管理', '', '', '', 1, 8, 1, 1, 'ethFeeList', '', 'system/ethFeeList/list', 0, 'sys_admin', 0, NULL, '2022-04-16 03:37:40', NULL);
INSERT INTO `sys_auth_rule` VALUES (344, 331, 'system/ethFeeList/get', '查询', '', '', '', 2, 0, 1, 1, '', '', '', 0, 'sys_admin', 0, NULL, '2022-04-16 02:06:52', NULL);
INSERT INTO `sys_auth_rule` VALUES (345, 331, 'system/ethWithdraw/list', '提现管理', '', '', '', 1, 6, 1, 1, 'ethWithdrawList', '', 'system/ethWithdraw/list', 0, 'sys_admin', 0, NULL, '2022-04-16 03:34:42', NULL);
INSERT INTO `sys_auth_rule` VALUES (346, 331, 'system/ethWithdraw/get', '查询', '', '', '', 2, 0, 1, 1, '', '', '', 0, 'sys_admin', 0, NULL, '2022-04-16 02:08:35', NULL);
INSERT INTO `sys_auth_rule` VALUES (347, 331, 'system/ethWithdraw/auditFail', '审核拒绝', '', '', '', 2, 0, 1, 1, '', '', '', 0, 'sys_admin', 0, '2022-04-16 17:24:49', '2022-04-16 17:24:49', NULL);
INSERT INTO `sys_auth_rule` VALUES (348, 331, 'system/ethCurrency/list', '币种管理', '', '', '', 1, 9, 1, 1, 'ethCurrency', '', 'system/ethCurrency/list', 0, 'sys_admin', 0, NULL, '2022-04-16 03:34:29', NULL);
...
INSERT INTO `sys_config` VALUES (2, '充值回调地址', 'sys.rechargeCallbackUrl', '', 1, 1, 1, '充值回调地址', NULL, '2023-10-14 20:25:03', NULL);
INSERT INTO `sys_config` VALUES (3, '提币自动通过金额', 'sys.minWithdrawAudit', '0', 1, 1, 1, '提币自动通过金额', NULL, '2023-05-17 21:33:35', NULL);
INSERT INTO `sys_config` VALUES (4, 'EHT归集地址', 'sys.ethMergeAddress', '', 0, 0, 1, 'EHT归集地址', NULL, '2023-04-11 14:39:46', NULL);
INSERT INTO `sys_config` VALUES (5, 'EHT链gasPrice', 'sys.ethGasPrice', '10', 1, 1, 1, 'EHTgasPrice', NULL, '2023-10-14 20:56:02', NULL);
INSERT INTO `sys_config` VALUES (6, 'EHT链gasLimit', 'sys.ethGasLimit', '500000', 1, 1, 1, 'EHTgasLimit', NULL, '2023-10-14 20:56:11', NULL);
INSERT INTO `sys_config` VALUES (7, 'EHT链提币地址', 'sys.ethWithdrawAddress', '', 1, 1, 1, 'EHT提币地址', NULL, '2023-05-15 20:36:45', NULL);
INSERT INTO `sys_config` VALUES (8, 'EHT链提币地址密钥', 'sys.ethWithdrawAddressPrivateKey', '', 1, 1, 1, 'EHT提币地址密钥', NULL, '2023-05-16 16:55:41', NULL);
INSERT INTO `sys_config` VALUES (9, 'EHT链手续费地址', 'sys.ethFeeAddress', '', 1, 1, 1, 'EHT手续费地址', NULL, '2023-04-11 14:44:28', NULL);
INSERT INTO `sys_config` VALUES (10, 'EHT链手续费地址密钥', 'sys.ethFeeAddressPrivateKey', '', 1, 1, 1, 'EHT手续费地址密钥', NULL, '2023-04-11 14:45:48', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 88 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '字典数据表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '字典类型表' ROW_FORMAT = Dynamic;
...
-- Records of sys_job
-- ----------------------------
INSERT INTO `sys_job` VALUES (1, 'EHT扫描任务', '', '', 'ethSweepTask', '*/10 * * * * ?', 1, 1, 0, 0, 1, '', NULL, '2023-10-09 02:04:09', NULL);
...
CREATE TABLE `sys_login_log`  (
  ...
  `module` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '登录模块',
  PRIMARY KEY (`info_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 25 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统访问记录' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文档模型表' ROW_FORMAT = Dynamic;
...
) ENGINE = MyISAM AUTO_INCREMENT = 251 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_user`  (
  ...
  `user_name` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '用户名',
  `mobile` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '中国手机不带国家代码，国际手机号格式为：国家代码-手机号',
  ...
  `user_password` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '登录密码;cmf_password加密',
  `user_salt` char(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '加密盐',
  ...
  `describe` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT ' 描述信息',
  `phone_num` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '联系电话',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'V8R4aF5dYTtcv6LG', '18800000000', '超级管理员', 0, '52e64d9fd45edb45e36a04f17971b5da', 'bynrGbgkiK', 1, 'admin@qq.com', 1, 'pub_upload/2022-04-11/cj6sdjf021iw6samde.jpeg', 100, '', 1, 'asdasfdsaf大发放打发士大夫发按时', '描述信息', '18611111111', '141.164.37.242', '2023-10-19 19:12:37', '2021-06-22 17:58:00', '2022-04-11 03:10:21', NULL);
...
CREATE TABLE `sys_user_online`  (
  ...
  `ip` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '登录ip',
  `explorer` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '浏览器',
  `os` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '操作系统',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uni_token`(`token`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 26 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户在线状态表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_user_online
-- ----------------------------
INSERT INTO `sys_user_online` VALUES (25, '8637807e2959eff73c84c00ac5287790', 'kVkWiVR4k2Dg1saG2/MSAZiVVVToBLnv0SRJtZYpLRDKGurhFYrUph6hThPdtfTMncWKIbXctsdXRRZbDjj3WZaI1u94cp0PYl9Q5owutIHWJkeVEDjYWy+lmlZrtsOeZAgDFF4xb75t+aLRpx6Fmg==', '2023-10-19 19:12:37', 'gnsTvDCI4MVxfRTB', '141.164.37.242', 'Chrome', 'Windows 10');
...
) ENGINE = InnoDB AUTO_INCREMENT = 76 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '代码生成业务表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 781 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '代码生成业务表字段' ROW_FORMAT = Dynamic;
...
CREATE TABLE `withdraw`  (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `main_chain` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '主链',
  `coin_token` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '币种 ',
  `withdraw_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '转出地址',
  `address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '转入地址',
  ...
  `nonce1` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'nonce1',
  `hashKey` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'hashKey',
  `hash` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '交易Hash',
  `remarks` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '交易备注',
  `notify_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '交易回调地址',
  `token_id` bigint NULL DEFAULT NULL COMMENT 'tokenID (nft使用)',
  `url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'url (nft使用)',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
