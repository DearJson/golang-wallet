...
type tronRecharge struct {
	SystemBase
}

var TronRecharge = new(tronRecharge)

// List 列表
func (c *tronRecharge) List(r *ghttp.Request) {
...
// Get 获取
func (c *tronRecharge) Get(r *ghttp.Request) {
	id := r.GetInt64("id")
...
// Callback 发起回调
func (c *tronRecharge) Callback(r *ghttp.Request) {
	ids := r.GetArray("ids")
	if len(ids) <= 0 {
