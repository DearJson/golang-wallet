...
type nacRecharge struct {
	SystemBase
}

var NacRecharge = new(nacRecharge)

// List 列表
func (c *nacRecharge) List(r *ghttp.Request) {
...
// Get 获取
func (c *nacRecharge) Get(r *ghttp.Request) {
	id := r.GetInt64("id")
...
// Callback 发起回调
func (c *nacRecharge) Callback(r *ghttp.Request) {
	ids := r.GetArray("ids")
	if len(ids) <= 0 {
