...
type hecoCurrency struct {
	SystemBase
}

var HecoCurrency = new(hecoCurrency)

// List 列表
func (c *hecoCurrency) List(r *ghttp.Request) {
...
// Add 添加
func (c *hecoCurrency) Add(r *ghttp.Request) {
...
// Get 获取
func (c *hecoCurrency) Get(r *ghttp.Request) {
	id := r.GetUint64("id")
	if id == 0 {
...
// Edit 修改
func (c *hecoCurrency) Edit(r *ghttp.Request) {
...
// Delete 删除
func (c *hecoCurrency) Delete(r *ghttp.Request) {
	ids := r.GetInts("ids")
