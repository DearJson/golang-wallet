...
var EthCurrency = new(ethCurrency)

// List 列表
func (c *ethCurrency) List(r *ghttp.Request) {
...
// Add 添加
func (c *ethCurrency) Add(r *ghttp.Request) {
...
// Get 获取
func (c *ethCurrency) Get(r *ghttp.Request) {
	id := r.GetUint64("id")
	if id == 0 {
...
// Edit 修改
func (c *ethCurrency) Edit(r *ghttp.Request) {
...
// Delete 删除
func (c *ethCurrency) Delete(r *ghttp.Request) {
	ids := r.GetInts("ids")
