...
var TronCurrency = new(tronCurrency)

// List 列表
func (c *tronCurrency) List(r *ghttp.Request) {
...
// Add 添加
func (c *tronCurrency) Add(r *ghttp.Request) {
...
// Get 获取
func (c *tronCurrency) Get(r *ghttp.Request) {
	id := r.GetUint64("id")
	if id == 0 {
...
// Edit 修改
func (c *tronCurrency) Edit(r *ghttp.Request) {
...
// Delete 删除
func (c *tronCurrency) Delete(r *ghttp.Request) {
	ids := r.GetInts("ids")
