...
type nacCurrency struct {
	SystemBase
}

var NacCurrency = new(nacCurrency)

// List 列表
func (c *nacCurrency) List(r *ghttp.Request) {
...
// Add 添加
func (c *nacCurrency) Add(r *ghttp.Request) {
...
// Get 获取
func (c *nacCurrency) Get(r *ghttp.Request) {
	id := r.GetUint64("id")
	if id == 0 {
...
// Edit 修改
func (c *nacCurrency) Edit(r *ghttp.Request) {
...
// Delete 删除
func (c *nacCurrency) Delete(r *ghttp.Request) {
	ids := r.GetInts("ids")
