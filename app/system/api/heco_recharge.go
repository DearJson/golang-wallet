...
type hecoRecharge struct {
	SystemBase
}

var HecoRecharge = new(hecoRecharge)

// List 列表
func (c *hecoRecharge) List(r *ghttp.Request) {
...
// Get 获取
func (c *hecoRecharge) Get(r *ghttp.Request) {
	id := r.GetInt64("id")
...
// Callback 发起回调
func (c *hecoRecharge) Callback(r *ghttp.Request) {
	ids := r.GetArray("ids")
	if len(ids) <= 0 {
