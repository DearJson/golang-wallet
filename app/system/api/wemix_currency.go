...
type wemixCurrency struct {
	SystemBase
}

var WemixCurrency = new(wemixCurrency)

// List 列表
func (c *wemixCurrency) List(r *ghttp.Request) {
...
// Add 添加
func (c *wemixCurrency) Add(r *ghttp.Request) {
...
// Get 获取
func (c *wemixCurrency) Get(r *ghttp.Request) {
	id := r.GetUint64("id")
	if id == 0 {
...
// Edit 修改
func (c *wemixCurrency) Edit(r *ghttp.Request) {
...
// Delete 删除
func (c *wemixCurrency) Delete(r *ghttp.Request) {
	ids := r.GetInts("ids")
