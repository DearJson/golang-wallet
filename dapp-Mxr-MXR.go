...
func main() {
	...
	dappMxrMa, err := dappMxrPayment.NewDappMxrPayment(common.HexToAddress("0x9d246C8a89d634D53C2B7d9eD41B1377b676A49D"), client)
	if err != nil {
	...
	val, err := dappMxrMa.WithdrawToCoinAddress(transactOptss, common.HexToAddress("0x7dF2D641E4d2cE62f282AD3bB8f38D839aa3fcb9"), convertAmount)
	if err != nil {
		fmt.Printf("转账失败")
		return
	}
